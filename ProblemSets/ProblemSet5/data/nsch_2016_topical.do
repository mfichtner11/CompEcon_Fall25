...
label var a1_grade_if "Imputation Flag for A1_GRADE_I"
...
label var family "Family Structure"
label var famcount "Number of People That Are Family Members"
label var hhcount "Number of People Living at Address"
label var hhsize_i "Number of People Living at Address (Recode)"
label var a2_k11q50_r "Adult 2 - Employed 50 Out Of Last 52 Weeks"
...
label var a1_k11q50_r "Adult 1 - Employed 50 Out Of Last 52 Weeks"
...
label var emosupspo "Emotional Support - Spouse"
...
label var k7q91_r "How Much Time Spent with Computers"
label var k7q60_r "How Much Time Spent Watching TV"
...
label var expulsion "Asked To Keep Child Home"
...
label var planutd "Plan Currently Up-To-Date"
label var receivecopy "Receive Written Copy of Plan"
label var planneeds "Plan Identify Specific Health Goals or Needs"
...
label var planfuture "Doctor Worked with Child to Plan For Future"
...
label var k5q31_r "Communication with School, Child Care, Special Education Program"
...
label var discussopt "How Often - Discussed Range of Options"
label var decisions "Health Care Services Treatment Decisions"
...
label var spcservmo "Received Special Services - Age in Months"
...
label var sesplanmo "Special Education Plan - Age in Months"
...
label var dentistvisit "Dental Provider Visit - How Many Visits"
...
label var usualsick "Place Usually Goes Routine Same As Sick"
label var usualgo "Place Usually Goes Routine Preventive Care"
label var k4q02_r "Place Usually Goes Sick - Where"
label var k4q01 "Place Usually Goes Sick"
label var k6q14b "Behaves and Gets Along Concerns"
label var k6q14a "Words and Phrases Concerns"
label var k6q13b "Interaction Concerns"
label var k6q13a "Talks or Speech Sounds Concerns"
label var k6q12 "Questionnaire - Development Concerns"
label var k6q10 "Learning, Development, Behavior Concerns"
label var wgtconc "Concerned About Weight"
label var docprivate "Child Speak with Doctor Privately"
label var docroom "Doctor Visit - How Long with Doctor"
label var k4q20r "Doctor Visit - How Many Times"
...
label var k2q05 "Born 3 Weeks Before Due Date"
label var k6q43r_never "First Fed Other - Never"
label var frstsolids_mo_s "First Fed Solids - Months (Standardized)"
label var frstsolids_wk_s "First Fed Solids - Weeks (Standardized)"
...
label var k2q31c "ADD/ADHD Description"
...
label var k2q35d "Autism ASD - Doctor Diagnose"
label var k2q35a_1_years "Autism ASD How Old - Age in Years"
label var k2q35c "Autism ASD Description"
label var k2q35b "Autism ASD Currently"
label var k2q35a "Autism ASD"
label var anyother_desc "Any Other Condition Description"
label var anyother_curr "Any Other Condition Currently"
label var anyother "Any Other Condition"
label var k2q30c "Learning Disability Description"
label var k2q30b "Learning Disability Currently"
label var k2q30a "Learning Disability"
label var k2q37c "Speech Disorder Description"
label var k2q37b "Speech Disorder Currently"
label var k2q37a "Speech Disorder"
label var k2q60c "Intellectual Disability Description"
label var k2q60b "Intellectual Disability Currently"
label var k2q60a "Intellectual Disability"
label var k2q36c "Developmental Delay Description"
label var k2q36b "Developmental Delay Currently"
label var k2q36a "Developmental Delay"
label var subabuse_desc "Substance Abuse Disorder Description"
label var subabuse_curr "Substance Abuse Disorder Currently"
label var subabuse "Substance Abuse Disorder"
label var k2q34c "Behavior Problems Description"
label var k2q34b "Behavior Problems Currently"
label var k2q34a "Behavior Problems"
label var k2q32c "Depression Description"
label var k2q32b "Depression Currently"
label var k2q32a "Depression"
label var k2q33c "Anxiety Description"
label var k2q33b "Anxiety Currently"
label var k2q33a "Anxiety"
label var k2q38c "Tourette Syndrome Description"
label var k2q38b "Tourette Syndrome Currently"
label var k2q38a "Tourette Syndrome"
label var headache_desc "Headaches Description"
label var headache_curr "Headaches Currently"
label var headache "Headaches"
label var heart_desc "Heart Condition Description"
label var heart_curr "Heart Condition Currently"
label var heart "Heart Condition"
label var genetic_desc "Genetic Condition Description"
label var genetic_curr "Genetic Condition Currently"
label var genetic "Genetic Condition"
label var k2q42c "Epilepsy Description"
label var k2q42b "Epilepsy Currently"
label var k2q42a "Epilepsy"
label var downsyn_desc "Down Syndrome Description"
label var downsyn_curr "Down Syndrome Currently"
label var downsyn "Down Syndrome"
label var k2q41c "Diabetes Description"
label var k2q41b "Diabetes Currently"
label var k2q41a "Diabetes"
label var cystfib_curr "Cystic Fibrosis Currently"
label var cystfib "Cystic Fibrosis"
label var cerpals_desc "Cerebral Palsy Description"
label var k2q61b "Cerebral Palsy Currently"
label var k2q61a "Cerebral Palsy"
label var k2q46c "Brain Injury Description"
label var k2q46b "Brain Injury Currently"
label var k2q46a "Brain Injury"
label var blood_desc "Blood Disorder Description"
label var blood_curr "Blood Disorder Currently"
label var blood "Blood Disorder"
label var k2q40c "Asthma Description"
label var k2q40b "Asthma Currently"
label var k2q40a "Asthma"
label var arthritis_desc "Arthritis Description"
label var arthritis_curr "Arthritis Currently"
label var arthritis "Arthritis"
label var allergies_desc "Allergies Description"
...
label var cavities "Difficulty Cavities"
label var gumbleed "Difficulty Bleeding Gums"
label var toothaches "Difficulty Toothaches"
label var coordination "Difficulty Coordination"
label var hands "Difficulty Hands"
label var physicalpain "Difficulty Physical Pain"
label var stomach "Difficulty Stomach"
label var swallowing "Difficulty Swallowing"
label var breathing "Difficulty Breathing"
label var k7q70_r "Argues Too Much"
label var k7q71_r "Bullies Others, Picks on Them, or Excludes Them"
label var bullied "Bullied, Picked On, or Excluded by Others"
...
label var sc_k2q23 "SC Emotion Develop Behave 12 Months"
label var sc_k2q22 "SC Emotion Develop Behave Treatment"
label var sc_k2q21 "SC Special Therapy Currently 12 Months"
label var sc_k2q20 "SC Special Therapy Currently Condition"
label var sc_k2q19 "SC Special Therapy Currently"
label var sc_k2q18 "SC Limited Ability Currently 12 Months"
label var sc_k2q17 "SC Limited Ability Currently Condition"
label var sc_k2q16 "SC Limited Ability Currently"
label var sc_k2q15 "SC Medical Care Currently 12 Months"
label var sc_k2q14 "SC Medical Care Currently Condition"
label var sc_k2q13 "SC Medical Care Currently"
label var sc_k2q12 "SC Medication Currently 12 Months"
label var sc_k2q11 "SC Medication Currently Condition"
label var sc_k2q10 "SC Medication Currently"
...
label var hhlanguage "Primary HH Language"
label var totkids_r "Number of Children"
...
label define a1_grade_i_lab  1   "Less than High School"
 label define a1_grade_i_lab  2  "High School Graduate", add
 label define a1_grade_i_lab  3  "More than High School", add
 label define a1_grade_i_lab  .n  "Not in universe", add
 label define a1_grade_i_lab  .l  "Logical skip", add
 label define a1_grade_i_lab  .m  "No valid response", add
  cap label values a1_grade_i a1_grade_i_lab
label define a1_grade_if_lab 1   "Imputed Value"
...
label define a1_k11q50_r_lab  1   "Yes"
 label define a1_k11q50_r_lab  2  "No", add
 label define a1_k11q50_r_lab  .m  "No valid response", add
 label define a1_k11q50_r_lab  .n  "Not in universe", add
 label define a1_k11q50_r_lab  .l  "Logical skip", add
 label define a1_k11q50_r_lab  .d  "Suppressed for confidentiality", add
  cap label values a1_k11q50_r a1_k11q50_r_lab
...
label define a1_relation_lab  1   "Biological or Adoptive Parent"
 ...
 label define a1_relation_lab  5  "Aunt or Uncle", add
...
label define a2_k11q50_r_lab  1   "Yes"
 label define a2_k11q50_r_lab  2  "No", add
 label define a2_k11q50_r_lab  .m  "No valid response", add
 label define a2_k11q50_r_lab  .n  "Not in universe", add
 label define a2_k11q50_r_lab  .l  "Logical skip", add
 label define a2_k11q50_r_lab  .d  "Suppressed for confidentiality", add
  cap label values a2_k11q50_r a2_k11q50_r_lab
...
label define a2_relation_lab  1   "Biological or Adoptive Parent"
 ...
 label define a2_relation_lab  5  "Aunt or Uncle", add
 label define a2_relation_lab  6  "Other: Relative", add
 label define a2_relation_lab  7  "Other: Non-Relative", add
 label define a2_relation_lab  8  "There is only one primary adult caregiver for this child", add
...
label define anyother_curr_lab  1   "Yes"
 label define anyother_curr_lab  2  "No", add
 label define anyother_curr_lab  .m  "No valid response", add
 label define anyother_curr_lab  .n  "Not in universe", add
 label define anyother_curr_lab  .l  "Logical skip", add
 label define anyother_curr_lab  .d  "Suppressed for confidentiality", add
  cap label values anyother_curr anyother_curr_lab
label define anyother_desc_lab  1   "Mild"
 label define anyother_desc_lab  2  "Moderate", add
 label define anyother_desc_lab  3  "Severe", add
 label define anyother_desc_lab  .m  "No valid response", add
 label define anyother_desc_lab  .n  "Not in universe", add
 label define anyother_desc_lab  .l  "Logical skip", add
 label define anyother_desc_lab  .d  "Suppressed for confidentiality", add
  cap label values anyother_desc anyother_desc_lab
label define anyother_lab  1   "Yes"
 label define anyother_lab  2  "No", add
 label define anyother_lab  .m  "No valid response", add
 label define anyother_lab  .n  "Not in universe", add
 label define anyother_lab  .l  "Logical skip", add
 label define anyother_lab  .d  "Suppressed for confidentiality", add
  cap label values anyother anyother_lab
...
label define arrangehc_lab  6   "This child does not need health care provided on a weekly basis"
 label define arrangehc_lab  1  "No health or medical care was arranged or coordinated by me or other family members", add
...
label define athomehc_lab  6   "This child does not need health care provided on a weekly basis"
 label define athomehc_lab  1  "No at home care was provided by me or other family members", add
...
label define birthwt_lab  1   "Very Low Birth Weight"
 label define birthwt_lab  2  "Low Birth Weight", add
...
label define blood_curr_lab  1   "Yes"
 label define blood_curr_lab  2  "No", add
 label define blood_curr_lab  .m  "No valid response", add
 label define blood_curr_lab  .n  "Not in universe", add
 label define blood_curr_lab  .l  "Logical skip", add
 label define blood_curr_lab  .d  "Suppressed for confidentiality", add
  cap label values blood_curr blood_curr_lab
...
label define bullied_lab  1   "Definitely true"
 label define bullied_lab  2  "Somewhat true", add
 label define bullied_lab  3  "Not true", add
 label define bullied_lab  .m  "No valid response", add
 label define bullied_lab  .n  "Not in universe", add
 label define bullied_lab  .l  "Logical skip", add
 label define bullied_lab  .d  "Suppressed for confidentiality", add
  cap label values bullied bullied_lab
...
label define c_hispanic_r_if_lab 1   "Imputed Value"
...
label define c_race_r_if_lab 1   "Imputed Value"
...
label define c_race_r_lab  1   "White alone"
 ...
 label define c_race_r_lab  6  "Some Other Race alone", add
...
label define c_sex_if_lab 1   "Imputed Value"
...
label define calmdown_lab  1   "All of the time"
 label define calmdown_lab  2  "Most of the time", add
 label define calmdown_lab  3  "Some of the time", add
 label define calmdown_lab  4  "None of the time", add
...
label define changeage_lab  1   "Yes"
 ...
 label define changeage_lab  3  "Dont Know", add
...
label define clearexp_lab  1   "All of the time"
 label define clearexp_lab  2  "Most of the time", add
 label define clearexp_lab  3  "Some of the time", add
 label define clearexp_lab  4  "None of the time", add
...
label define countto_lab  1   "Not at all"
 ...
 label define countto_lab  6  "Up to 100", add
...
label define currins_lab  1   "Currently insured"
 label define currins_lab  2  "Currently uninsured", add
...
label define cystfib_curr_lab  1   "Yes"
 label define cystfib_curr_lab  2  "No", add
 label define cystfib_curr_lab  .m  "No valid response", add
 label define cystfib_curr_lab  .n  "Not in universe", add
 label define cystfib_curr_lab  .l  "Logical skip", add
 label define cystfib_curr_lab  .d  "Suppressed for confidentiality", add
  cap label values cystfib_curr cystfib_curr_lab
label define cystfib_desc_lab  1   "Mild"
 label define cystfib_desc_lab  2  "Moderate", add
 label define cystfib_desc_lab  3  "Severe", add
 label define cystfib_desc_lab  4  "Moderate/Severe", add
 label define cystfib_desc_lab  .m  "No valid response", add
 label define cystfib_desc_lab  .n  "Not in universe", add
 label define cystfib_desc_lab  .l  "Logical skip", add
 label define cystfib_desc_lab  .d  "Suppressed for confidentiality", add
  cap label values cystfib_desc cystfib_desc_lab
...
label define dentalserv1_lab  2   "not selected"
 label define dentalserv1_lab  1  "selected", add
...
label define dentalserv2_lab  2   "not selected"
 label define dentalserv2_lab  1  "selected", add
...
label define dentalserv3_lab  2   "not selected"
 label define dentalserv3_lab  1  "selected", add
...
label define dentalserv4_lab  2   "not selected"
 label define dentalserv4_lab  1  "selected", add
...
label define dentalserv5_lab  2   "not selected"
 label define dentalserv5_lab  1  "selected", add
...
label define dentalserv6_lab  2   "not selected"
 label define dentalserv6_lab  1  "selected", add
...
label define dentalserv7_lab  2   "not selected"
 label define dentalserv7_lab  1  "selected", add
...
label define distracted_lab  1   "All of the time"
 label define distracted_lab  2  "Most of the time", add
 label define distracted_lab  3  "Some of the time", add
 label define distracted_lab  4  "None of the time", add
...
label define downsyn_curr_lab  1   "Yes"
 label define downsyn_curr_lab  2  "No", add
 label define downsyn_curr_lab  .m  "No valid response", add
 label define downsyn_curr_lab  .n  "Not in universe", add
 label define downsyn_curr_lab  .l  "Logical skip", add
 label define downsyn_curr_lab  .d  "Suppressed for confidentiality", add
  cap label values downsyn_curr downsyn_curr_lab
label define downsyn_desc_lab  1   "Mild"
 label define downsyn_desc_lab  4  "Moderate/Severe", add
 label define downsyn_desc_lab  .m  "No valid response", add
 label define downsyn_desc_lab  .n  "Not in universe", add
 label define downsyn_desc_lab  .l  "Logical skip", add
 label define downsyn_desc_lab  .d  "Suppressed for confidentiality", add
  cap label values downsyn_desc downsyn_desc_lab
...
label define expulsion_lab  1   "This child did not attend child care or preschool"
 label define expulsion_lab  2  "No", add
 label define expulsion_lab  3  "Yes, I was told to pick up my child early on 1 or more days", add
 label define expulsion_lab  4  "Yes, I had to keep my child home for 1 full day or more", add
 label define expulsion_lab  5  "Yes, permanently I was told my child could no longer attend this child care center or preschool", add
 label define expulsion_lab  .m  "No valid response", add
 label define expulsion_lab  .n  "Not in universe", add
 label define expulsion_lab  .l  "Logical skip", add
 label define expulsion_lab  .d  "Suppressed for confidentiality", add
  cap label values expulsion expulsion_lab
label define family_lab  1   "Two biogical/adoptive parents, currently married"
 label define family_lab  2  "Two biogical/adoptive parents, not currently married", add
 label define family_lab  3  "Two parents (at least one not biological/adoptive), currently married", add
 label define family_lab  4  "Two parents (at least one not biological/adoptive), not currently married", add
 label define family_lab  5  "One mother, currently married (living apart) or formerly married", add
 label define family_lab  6  "One mother, never married", add
 label define family_lab  7  "Other, currently married or formerly married", add
 label define family_lab  8  "Other, never married", add
 label define family_lab  9  "Other, no parent in household", add
 label define family_lab  .m  "No valid response", add
 label define family_lab  .n  "Not in universe", add
 label define family_lab  .l  "Logical skip", add
 label define family_lab  .d  "Suppressed for confidentiality", add
  cap label values family family_lab
...
label define genetic_curr_lab  1   "Yes"
 label define genetic_curr_lab  2  "No", add
 label define genetic_curr_lab  .m  "No valid response", add
 label define genetic_curr_lab  .n  "Not in universe", add
 label define genetic_curr_lab  .l  "Logical skip", add
 label define genetic_curr_lab  .d  "Suppressed for confidentiality", add
  cap label values genetic_curr genetic_curr_lab
...
label define hcability_lab  1   "This child does not have any conditions"
...
label define hhsize_i_lab 5   "5 or more"
 label define hhsize_i_lab .n  "Not in universe", add
 label define hhsize_i_lab .l  "Logical skip", add
 label define hhsize_i_lab .m  "No valid response", add
  cap label values hhsize_i hhsize_i_lab
label define hhsize_if_lab 1   "Imputed Value"
  cap label values hhsize_if hhsize_if_lab
...
label define hospitaler_lab  1   "No visits"
 label define hospitaler_lab  2  "1 visit", add
 label define hospitaler_lab  3  "2 or more visits", add
...
label define house_gen_lab  1   "1st generation household"
 label define house_gen_lab  2  "2nd generation household", add
 label define house_gen_lab  3  "3rd+ generation", add
 label define house_gen_lab  4  "Other (child born in United States, parents are not listed)", add
...
label define hurtsad_lab  1   "All of the time"
 label define hurtsad_lab  2  "Most of the time", add
 label define hurtsad_lab  3  "Some of the time", add
 label define hurtsad_lab  4  "None of the time", add
...
label define instype_lab  1   "Public Only"
 label define instype_lab  2  "Private Only", add
 label define instype_lab  3  "Private and public", add
 label define instype_lab  4  "Insurance type unspecified", add
...
label define k2q35d_lab  1   "Primary Care Provider"
 ...
 label define k2q35d_lab  7  "Dont Know", add
...
label define k2q38c_lab  1   "Mild"
 label define k2q38c_lab  2  "Moderate", add
 label define k2q38c_lab  3  "Severe", add
...
label define k2q46a_lab  1   "Yes"
 label define k2q46a_lab  2  "No", add
 label define k2q46a_lab  .m  "No valid response", add
 label define k2q46a_lab  .n  "Not in universe", add
 label define k2q46a_lab  .l  "Logical skip", add
 label define k2q46a_lab  .d  "Suppressed for confidentiality", add
  cap label values k2q46a k2q46a_lab
label define k2q46b_lab  1   "Yes"
 label define k2q46b_lab  2  "No", add
 label define k2q46b_lab  .m  "No valid response", add
 label define k2q46b_lab  .n  "Not in universe", add
 label define k2q46b_lab  .l  "Logical skip", add
 label define k2q46b_lab  .d  "Suppressed for confidentiality", add
  cap label values k2q46b k2q46b_lab
label define k2q46c_lab  1   "Mild"
 label define k2q46c_lab  2  "Moderate", add
 label define k2q46c_lab  3  "Severe", add
 label define k2q46c_lab  .m  "No valid response", add
 label define k2q46c_lab  .n  "Not in universe", add
 label define k2q46c_lab  .l  "Logical skip", add
 label define k2q46c_lab  .d  "Suppressed for confidentiality", add
  cap label values k2q46c k2q46c_lab
...
label define k4q02_r_lab  1   "Doctors Office"
 ...
 label define k4q02_r_lab  6  "School (Nurses Office, Athletic Trainers Office)", add
...
label define k4q26_lab  1   "Not a problem"
 label define k4q26_lab  2  "Small problem", add
 label define k4q26_lab  3  "Big problem", add
...
label define k4q28x_ear_lab  2   "not selected"
 label define k4q28x_ear_lab  1  "selected", add
...
label define k4q28x01_lab  2   "not selected"
 label define k4q28x01_lab  1  "selected", add
...
label define k4q28x02_lab  2   "not selected"
 label define k4q28x02_lab  1  "selected", add
...
label define k4q28x03_lab  2   "not selected"
 label define k4q28x03_lab  1  "selected", add
...
label define k4q28x04_lab  2   "not selected"
 label define k4q28x04_lab  1  "selected", add
...
label define k4q28x05_lab  2   "not selected"
 label define k4q28x05_lab  1  "selected", add
...
label define k4q32x01_lab  2   "not selected"
 label define k4q32x01_lab  1  "selected", add
...
label define k4q32x02_lab  2   "not selected"
 label define k4q32x02_lab  1  "selected", add
...
label define k4q32x03_lab  2   "not selected"
 label define k4q32x03_lab  1  "selected", add
...
label define k4q32x04_lab  2   "not selected"
 label define k4q32x04_lab  1  "selected", add
...
label define k4q32x05_lab  2   "not selected"
 label define k4q32x05_lab  1  "selected", add
...
label define k5q11_lab  1   "Not a problem"
 label define k5q11_lab  2  "Small problem", add
 label define k5q11_lab  3  "Big problem", add
...
label define k5q20_r_lab  1   "Yes"
 ...
 label define k5q20_r_lab  3  "Did not see more than one health care provider in past 12 months", add
...
label define k6q08_r_lab  1   "Very well"
 label define k6q08_r_lab  2  "Somewhat", add
 label define k6q08_r_lab  3  "Poorly", add
 label define k6q08_r_lab  4  "Not at all", add
...
label define k6q13a_lab  2   "not selected"
 label define k6q13a_lab  1  "selected", add
...
label define k6q13b_lab  2   "not selected"
 label define k6q13b_lab  1  "selected", add
...
label define k6q14a_lab  2   "not selected"
 label define k6q14a_lab  1  "selected", add
...
label define k6q14b_lab  2   "not selected"
 label define k6q14b_lab  1  "selected", add
...
label define k6q41r_still_lab  2   "not selected"
 label define k6q41r_still_lab  1  "selected", add
...
label define k6q42r_never_lab  2   "not selected"
 label define k6q42r_never_lab  1  "selected", add
...
label define k6q43r_never_lab  2   "not selected"
 label define k6q43r_never_lab  1  "selected", add
...
label define k6q70_r_lab  1   "Definitely true"
 label define k6q70_r_lab  2  "Somewhat true", add
 label define k6q70_r_lab  3  "Not true", add
...
label define k6q71_r_lab  1   "Definitely true"
 label define k6q71_r_lab  2  "Somewhat true", add
 label define k6q71_r_lab  3  "Not true", add
...
label define k6q72_r_lab  1   "Definitely true"
 label define k6q72_r_lab  2  "Somewhat true", add
 label define k6q72_r_lab  3  "Not true", add
...
label define k6q73_r_lab  1   "Definitely true"
 label define k6q73_r_lab  2  "Somewhat true", add
 label define k6q73_r_lab  3  "Not true", add
...
label define k7q04r_r_lab  1   "No times"
...
label define k7q60_r_lab  1   "None"
 label define k7q60_r_lab  2  "Less than 1 hour", add
 label define k7q60_r_lab  3  "1 hour", add
 label define k7q60_r_lab  4  "2 hours", add
 label define k7q60_r_lab  5  "3 hours", add
 label define k7q60_r_lab  6  "4 or more hours", add
 label define k7q60_r_lab  .m  "No valid response", add
 label define k7q60_r_lab  .n  "Not in universe", add
 label define k7q60_r_lab  .l  "Logical skip", add
 label define k7q60_r_lab  .d  "Suppressed for confidentiality", add
  cap label values k7q60_r k7q60_r_lab
label define k7q70_r_lab  1   "Definitely true"
 label define k7q70_r_lab  2  "Somewhat true", add
 label define k7q70_r_lab  3  "Not true", add
...
label define k7q71_r_lab  1   "Definitely true"
 label define k7q71_r_lab  2  "Somewhat true", add
 label define k7q71_r_lab  3  "Not true", add
 label define k7q71_r_lab  .m  "No valid response", add
 label define k7q71_r_lab  .n  "Not in universe", add
 label define k7q71_r_lab  .l  "Logical skip", add
 label define k7q71_r_lab  .d  "Suppressed for confidentiality", add
  cap label values k7q71_r k7q71_r_lab
label define k7q82_r_lab  1   "Definitely true"
 label define k7q82_r_lab  2  "Somewhat true", add
 label define k7q82_r_lab  3  "Not true", add
...
label define k7q83_r_lab  1   "Definitely true"
 label define k7q83_r_lab  2  "Somewhat true", add
 label define k7q83_r_lab  3  "Not true", add
...
label define k7q84_r_lab  1   "Definitely true"
 label define k7q84_r_lab  2  "Somewhat true", add
 label define k7q84_r_lab  3  "Not true", add
...
label define k7q85_r_lab  1   "Definitely true"
 label define k7q85_r_lab  2  "Somewhat true", add
 label define k7q85_r_lab  3  "Not true", add
...
label define k7q91_r_lab  1   "None"
 label define k7q91_r_lab  2  "Less than 1 hour", add
 label define k7q91_r_lab  3  "1 hour", add
 label define k7q91_r_lab  4  "2 hours", add
 label define k7q91_r_lab  5  "3 hours", add
 label define k7q91_r_lab  6  "4 or more hours", add
 label define k7q91_r_lab  .m  "No valid response", add
 label define k7q91_r_lab  .n  "Not in universe", add
 label define k7q91_r_lab  .l  "Logical skip", add
 label define k7q91_r_lab  .d  "Suppressed for confidentiality", add
  cap label values k7q91_r k7q91_r_lab
...
label define k8q21_lab  1   "Very well"
 ...
 label define k8q21_lab  4  "Not at all", add
...
label define k8q30_lab  1   "Very well"
 ...
 label define k8q30_lab  4  "Not at all", add
...
label define makefriend_lab  1   "No difficulty"
 label define makefriend_lab  2  "A little difficulty", add
 label define makefriend_lab  3  "A lot of difficulty", add
...
label define metro_yn_lab  1   "In Metropolitan Statistical Area"
 label define metro_yn_lab  2  "Not in Metropolitan Statistical Area", add
 label define metro_yn_lab  .d  "Suppressed for confidentiality", add
  cap label values metro_yn metro_yn_lab
label define mpc_yn_lab  1   "In Metropolitan Principal City"
 label define mpc_yn_lab  2  "Not in Metropolitan Principal City", add
 label define mpc_yn_lab  .d  "Suppressed for confidentiality", add
  cap label values mpc_yn mpc_yn_lab
label define newactivity_lab  1   "All of the time"
 label define newactivity_lab  2  "Most of the time", add
 label define newactivity_lab  3  "Some of the time", add
 label define newactivity_lab  4  "None of the time", add
...
label define planfuture_lab  1   "Yes"
 label define planfuture_lab  2  "No", add
 label define planfuture_lab  3  "Dont Know", add
 label define planfuture_lab  .m  "No valid response", add
 label define planfuture_lab  .n  "Not in universe", add
 label define planfuture_lab  .l  "Logical skip", add
 label define planfuture_lab  .d  "Suppressed for confidentiality", add
  cap label values planfuture planfuture_lab
label define planneeds_lab  1   "Yes"
 label define planneeds_lab  2  "No", add
 label define planneeds_lab  .m  "No valid response", add
 label define planneeds_lab  .n  "Not in universe", add
 label define planneeds_lab  .l  "Logical skip", add
 label define planneeds_lab  .d  "Suppressed for confidentiality", add
  cap label values planneeds planneeds_lab
label define planutd_lab  1   "Yes"
 label define planutd_lab  2  "No", add
 label define planutd_lab  .m  "No valid response", add
 label define planutd_lab  .n  "Not in universe", add
 label define planutd_lab  .l  "Logical skip", add
 label define planutd_lab  .d  "Suppressed for confidentiality", add
  cap label values planutd planutd_lab
label define playwell_lab  1   "All of the time"
 label define playwell_lab  2  "Most of the time", add
 label define playwell_lab  3  "Some of the time", add
 label define playwell_lab  4  "None of the time", add
...
label define poschoice_lab  1   "Yes"
 ...
 label define poschoice_lab  3  "Dont Know", add
...
label define race_hi_lab  1   "White alone"
 label define race_hi_lab  2  "Black or African American alone", add
 label define race_hi_lab  3  "Asian alone", add
 label define race_hi_lab  4  "Native Hawaiian and Other Pacific Islander alone", add
 label define race_hi_lab  5  "Other", add
 label define race_hi_lab  .m  "No valid response", add
 label define race_hi_lab  .n  "Not in universe", add
 label define race_hi_lab  .l  "Logical skip", add
 label define race_hi_lab  .d  "Suppressed for confidentiality", add
  cap label values race_hi race_hi_lab
label define raceaian_lab  1   "White alone"
 label define raceaian_lab  2  "Black or African American alone", add
 label define raceaian_lab  3  "American Indian or Alaska Native alone", add
 label define raceaian_lab  4  "Other", add
 label define raceaian_lab  .m  "No valid response", add
 label define raceaian_lab  .n  "Not in universe", add
 label define raceaian_lab  .l  "Logical skip", add
 label define raceaian_lab  .d  "Suppressed for confidentiality", add
  cap label values raceaian raceaian_lab
label define raceasia_lab  1   "White alone"
 label define raceasia_lab  2  "Black or African American alone", add
 label define raceasia_lab  3  "Asian alone", add
 label define raceasia_lab  4  "Other", add
 label define raceasia_lab  .m  "No valid response", add
 label define raceasia_lab  .n  "Not in universe", add
 label define raceasia_lab  .l  "Logical skip", add
 label define raceasia_lab  .d  "Suppressed for confidentiality", add
  cap label values raceasia raceasia_lab
...
label define recogabc_lab  1   "All of them"
 ...
 label define recogabc_lab  3  "Some of them", add
 label define recogabc_lab  4  "None of them", add
...
label define recogbegin_lab  1   "All of the time"
 label define recogbegin_lab  2  "Most of the time", add
 label define recogbegin_lab  3  "Some of the time", add
 label define recogbegin_lab  4  "None of the time", add
...
label define recshapes_lab  1   "All of the time"
 label define recshapes_lab  2  "Most of the time", add
 label define recshapes_lab  3  "Some of the time", add
 label define recshapes_lab  4  "None of the time", add
...
label define sc_hispanic_r_if_lab 1   "Imputed Value"
...
label define sc_race_hi_lab  1   "White alone"
 label define sc_race_hi_lab  2  "Black or African American alone", add
 label define sc_race_hi_lab  3  "Asian alone", add
 label define sc_race_hi_lab  4  "Native Hawaiian and Other Pacific Islander alone", add
 label define sc_race_hi_lab  5  "Other", add
 label define sc_race_hi_lab  .m  "No valid response", add
 label define sc_race_hi_lab  .n  "Not in universe", add
 label define sc_race_hi_lab  .l  "Logical skip", add
 label define sc_race_hi_lab  .d  "Suppressed for confidentiality", add
  cap label values sc_race_hi sc_race_hi_lab
label define sc_race_r_if_lab 1   "Imputed Value"
...
label define sc_race_r_lab  1   "White alone"
 ...
 label define sc_race_r_lab  6  "Some Other Race alone", add
...
label define sc_sex_if_lab 1   "Imputed Value"
...
label define simpleinst_lab  1   "All of the time"
 label define simpleinst_lab  2  "Most of the time", add
 label define simpleinst_lab  3  "Some of the time", add
 label define simpleinst_lab  4  "None of the time", add
...
label define sitstill_lab  1   "All of the time"
 label define sitstill_lab  2  "Most of the time", add
 label define sitstill_lab  3  "Some of the time", add
 label define sitstill_lab  4  "None of the time", add
...
label define sleeppos_lab  1   "On his or her side"
 label define sleeppos_lab  2  "On his or her back", add
 label define sleeppos_lab  3  "On his or her stomach", add
...
label define startschool_lab  1   "Yes"
 label define startschool_lab  2  "No", add
...
label define stratum_lab  1   "Stratum 1"
 label define stratum_lab  2  "Stratum 2", add
 label define stratum_lab  .m  "No valid response", add
 label define stratum_lab  .n  "Not in universe", add
 label define stratum_lab  .l  "Logical skip", add
 label define stratum_lab  .d  "Suppressed for confidentiality", add
  cap label values stratum stratum_lab
...
label define subabuse_curr_lab  1   "Yes"
 label define subabuse_curr_lab  2  "No", add
 label define subabuse_curr_lab  .m  "No valid response", add
 label define subabuse_curr_lab  .n  "Not in universe", add
 label define subabuse_curr_lab  .l  "Logical skip", add
 label define subabuse_curr_lab  .d  "Suppressed for confidentiality", add
  cap label values subabuse_curr subabuse_curr_lab
label define subabuse_desc_lab  1   "Mild"
 label define subabuse_desc_lab  2  "Moderate", add
 label define subabuse_desc_lab  3  "Severe", add
 label define subabuse_desc_lab  .m  "No valid response", add
 label define subabuse_desc_lab  .n  "Not in universe", add
 label define subabuse_desc_lab  .l  "Logical skip", add
 label define subabuse_desc_lab  .d  "Suppressed for confidentiality", add
  cap label values subabuse_desc subabuse_desc_lab
label define subabuse_lab  1   "Yes"
 label define subabuse_lab  2  "No", add
 label define subabuse_lab  .m  "No valid response", add
 label define subabuse_lab  .n  "Not in universe", add
 label define subabuse_lab  .l  "Logical skip", add
 label define subabuse_lab  .d  "Suppressed for confidentiality", add
  cap label values subabuse subabuse_lab
...
label define temper_lab  1   "All of the time"
 label define temper_lab  2  "Most of the time", add
 label define temper_lab  3  "Some of the time", add
 label define temper_lab  4  "None of the time", add
...
label define totkids_r_lab  1   "1"
 ...
 label define totkids_r_lab  4  "4 or more", add
...
label define treatneed_lab  1   "Not a problem"
 label define treatneed_lab  2  "Small problem", add
 label define treatneed_lab  3  "Big problem", add
...
label define usepencil_lab  1   "Uses fingers"
 label define usepencil_lab  2  "Grips in fist", add
 label define usepencil_lab  3  "Cannot hold a pencil", add
...
label define wgtconc_lab  1   "Yes, its too high"
 label define wgtconc_lab  2  "Yes, its too low", add
...
label define worktofin_lab  1   "All of the time"
 label define worktofin_lab  2  "Most of the time", add
 label define worktofin_lab  3  "Some of the time", add
 label define worktofin_lab  4  "None of the time", add
...
label define writename_lab  1   "All of the time"
 label define writename_lab  2  "Most of the time", add
 label define writename_lab  3  "Some of the time", add
 label define writename_lab  4  "None of the time", add
...
label define fipsst_lab 01 "Alabama"
...
label define fpl_lab  50  "50 or Less"
 label define fpl_lab  400  "400 or More", add
  cap label values fpl fpl_lab
label define momage_lab 45 "45 or older"
  cap label values momage momage_lab
label define sesplanyr_lab 16 "16 or 17"
  cap label values sesplanyr sesplanyr_lab
label define k4q37_lab 16 "16 or 17"
  cap label values k4q37 k4q37_lab
label define k11q43r_lab 15 "15 or more"  
  cap label values k11q43r k11q43r_lab
label define a1_age_lab 75 "75 or older"
  cap label values a1_age a1_age_lab
label define a1_liveusa_lab 1972 "1972 or earlier" 
 label define a1_liveusa_lab 2015 "2015 or 2016", add
  cap label values a1_liveusa a1_liveusa_lab
label define a2_age_lab 75 "75 or older"
  cap label values a2_age a2_age_lab
label define a2_liveusa_lab 1972 "1972 or earlier"
 label define a2_liveusa_lab 2015 "2015 or 2016", add
  cap label values a1_liveusa a1_liveusa_lab
label define hhcount_lab 12 "12 or more"
  cap label values hhcount hhcount_lab
label define famcount_lab 8 "8 or more"
...
label define fpl_i_lab  50  "50 or Less"
label define fpl_i_lab  400  "400 or More", add
  cap label values fpl_i1 fpl_i_lab
  cap label values fpl_i2 fpl_i_lab
  cap label values fpl_i3 fpl_i_lab
  cap label values fpl_i4 fpl_i_lab
  cap label values fpl_i5 fpl_i_lab
  cap label values fpl_i6 fpl_i_lab